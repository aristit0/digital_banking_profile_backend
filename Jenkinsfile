pipeline {
    ...
    environment {
        // Git Configuration
        GIT_REPO   = 'https://github.com/aristit0/digital_banking_profile_backend.git'
        GIT_BRANCH = 'main'

        // Docker Configuration
        DOCKER_IMAGE     = 'digital-banking-profile-backend'
        DOCKER_CONTAINER = 'digital-banking-profile-backend'
...
COPY . .
RUN CGO_ENABLED=0 GOOS=linux go build -o digital-banking-profile-api .
